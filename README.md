...
<p/>
The GIMPS project uses volunteer computational powers with a free program to search for primes. Essentially, anyone that has a PC with a decent CPU can start their prime hunt, it will usually take weeks to months for checking a new exponent with a specific method if the exponent is small enough and the computer runs 24/7 at high CPU usage. However, there are cash rewards offered to lucky person who finds a new prime, that include 3,000 (USD) GIMPS Research Discovery Award and 150,000 (USD) Electronic Frontier Foundation Award to the first person or group to discover a 100,000,000 digit prime number! You can make history too! See <a href="https://www.mersenne.org/"> https://www.mersenne.org/ </a> for details.
